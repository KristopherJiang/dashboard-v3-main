...
const dataA = [
  ...
  { month: 'F', value: 25, previous: 22 },
  { month: 'M', value: 23, previous: 20 },
  { month: 'A', value: 35, previous: 28 },
  { month: 'M', value: 40, previous: 32 },
  { month: 'J', value: 45, previous: 38 },
  { month: 'J', value: 50, previous: 42 },
  { month: 'A', value: 65, previous: 55 },
  { month: 'S', value: 80, previous: 60 },
  { month: 'O', value: 60, previous: 50 },
  { month: 'N', value: 70, previous: 55 },
  { month: 'D', value: 75, previous: 60 },
];

const dataA2 = [
  { month: '1月', current: 40, lastMonth: 38, lastYear: 35 },
  { month: '2月', current: 45, lastMonth: 40, lastYear: 40 },
  { month: '3月', current: 40, lastMonth: 45, lastYear: 45 },
  { month: '4月', current: 60, lastMonth: 40, lastYear: 50 },
  { month: '5月', current: 75, lastMonth: 60, lastYear: 60 },
  { month: '6月', current: 90, lastMonth: 75, lastYear: 70 },
  { month: '7月', current: 95, lastMonth: 90, lastYear: 75 },
  { month: '8月', current: 110, lastMonth: 95, lastYear: 85 },
  { month: '9月', current: 130, lastMonth: 110, lastYear: 95 },
  { month: '10月', current: 115, lastMonth: 130, lastYear: 80 },
  { month: '11月', current: 115, lastMonth: 115, lastYear: 80 },
  { month: '12月', current: 125, lastMonth: 115, lastYear: 90 },
];

const dataB = [
  { month: '1月', value: 30, lastMonth: 28, lastYear: 25, okr: 35, isUp: true },
  { month: '2月', value: 35, lastMonth: 30, lastYear: 30, okr: 35, isUp: true },
  { month: '3月', value: 40, lastMonth: 35, lastYear: 35, okr: 45, isUp: true },
  { month: '4月', value: 35, lastMonth: 40, lastYear: 40, okr: 45, isUp: false },
  { month: '5月', value: 50, lastMonth: 35, lastYear: 45, okr: 55, isUp: true },
  { month: '6月', value: 60, lastMonth: 50, lastYear: 50, okr: 55, isUp: true },
  { month: '7月', value: 55, lastMonth: 60, lastYear: 60, okr: 70, isUp: false },
  { month: '8月', value: 75, lastMonth: 55, lastYear: 65, okr: 70, isUp: true },
  { month: '9月', value: 85, lastMonth: 75, lastYear: 70, okr: 80, isUp: true },
  { month: '10月', value: 80, lastMonth: 85, lastYear: 75, okr: 90, isUp: false },
  { month: '11月', value: 95, lastMonth: 80, lastYear: 80, okr: 90, isUp: true },
  { month: '12月', value: 90, lastMonth: 95, lastYear: 85, okr: 100, isUp: false },
];

const dataC = [
  { month: '1月', actual: 40, lastMonth: 38, lastYear: 35, predict: null, barValue: 40 },
  { month: '2月', actual: 52, lastMonth: 40, lastYear: 45, predict: null, barValue: 52 },
  { month: '3月', actual: 45, lastMonth: 52, lastYear: 40, predict: null, barValue: 45 },
  { month: '4月', actual: 60, lastMonth: 45, lastYear: 50, predict: null, barValue: 60 },
  { month: '5月', actual: 55, lastMonth: 60, lastYear: 55, predict: null, barValue: 55 },
  { month: '6月', actual: 70, lastMonth: 55, lastYear: 60, predict: null, barValue: 70 },
  { month: '7月', actual: 65, lastMonth: 70, lastYear: 65, predict: null, barValue: 65 },
  { month: '8月', actual: 80, lastMonth: 65, lastYear: 70, predict: null, barValue: 80 },
  { month: '9月', actual: 75, lastMonth: 80, lastYear: 75, predict: null, barValue: 75 },
  { month: '10月', actual: 85, lastMonth: 75, lastYear: 80, predict: null, barValue: 85 },
  { month: '11月', actual: 92, lastMonth: null, lastYear: 85, predict: null, barValue: 92 },
  { month: '12月', actual: 105, lastMonth: null, lastYear: 90, predict: null, barValue: 105 },
];

const dataD = [
  { month: 'J', current: 300, previous: 200 },
  { month: 'F', current: 400, previous: 250 },
  { month: 'M', current: 350, previous: 300 },
  { month: 'A', current: 700, previous: 450 },
  { month: 'M', current: 500, previous: 400 },
  { month: 'J', current: 600, previous: 500 },
  { month: 'J', current: 550, previous: 450 },
  { month: 'A', current: 800, previous: 600 },
  { month: 'S', current: 750, previous: 550 },
  { month: 'O', current: 900, previous: 700 },
  { month: 'N', current: 850, previous: 650 },
  { month: 'D', current: 1000, previous: 800 },
];

const dataE = [
  { month: 'Jan', deposit: 4000, withdrawal: -2000 },
  { month: 'Feb', deposit: 5000, withdrawal: -2500 },
  { month: 'Mar', deposit: 4500, withdrawal: -3000 },
  { month: 'Apr', deposit: 6000, withdrawal: -2000 },
  { month: 'May', deposit: 7000, withdrawal: -3500 },
  { month: 'Jun', deposit: 6500, withdrawal: -4000 },
  { month: 'Jul', deposit: 8000, withdrawal: -3000 },
  { month: 'Aug', deposit: 9000, withdrawal: -4500 },
  { month: 'Sep', deposit: 13400, withdrawal: -4500 },
  { month: 'Oct', deposit: 11000, withdrawal: -5000 },
  { month: 'Nov', deposit: 12000, withdrawal: -6000 },
  { month: 'Dec', deposit: 14000, withdrawal: -5500 },
].reverse();
...
const dataConversion1 = [
  { month: '1月', current: 18.6, lastMonth: 18.0, lastYear: 17.5, target: 22.0 },
  { month: '2月', current: 19.3, lastMonth: 18.6, lastYear: 18.0, target: 22.0 },
  { month: '3月', current: 19.5, lastMonth: 19.3, lastYear: 18.5, target: 22.0 },
  { month: '4月', current: 20.1, lastMonth: 19.5, lastYear: 19.0, target: 22.0 },
  { month: '5月', current: 20.8, lastMonth: 20.1, lastYear: 19.5, target: 22.0 },
  { month: '6月', current: 21.2, lastMonth: 20.8, lastYear: 20.0, target: 22.0 },
  { month: '7月', current: 21.5, lastMonth: 21.2, lastYear: 20.5, target: 22.0 },
  { month: '8月', current: 22.5, lastMonth: 21.5, lastYear: 21.0, target: 22.0 },
  { month: '9月', current: 21.6, lastMonth: 22.5, lastYear: 20.8, target: 22.0 },
  { month: '10月', current: 22.1, lastMonth: 21.6, lastYear: 21.2, target: 22.0 },
  { month: '11月', current: 24.0, lastMonth: 22.1, lastYear: 22.0, target: 22.0 },
  { month: '12月', current: 24.5, lastMonth: 24.0, lastYear: 22.5, target: 22.0 },
];

const dataConversion2 = [
  { month: '1月', current: 44.2, lastMonth: 43.5, lastYear: 42.0, target: 55.0 },
  { month: '2月', current: 45.1, lastMonth: 44.2, lastYear: 43.0, target: 55.0 },
  { month: '3月', current: 46.1, lastMonth: 45.1, lastYear: 44.5, target: 55.0 },
  { month: '4月', current: 46.5, lastMonth: 46.1, lastYear: 45.0, target: 55.0 },
  { month: '5月', current: 47.3, lastMonth: 46.5, lastYear: 46.0, target: 55.0 },
  { month: '6月', current: 47.8, lastMonth: 47.3, lastYear: 46.5, target: 55.0 },
  { month: '7月', current: 48.2, lastMonth: 47.8, lastYear: 47.0, target: 55.0 },
  { month: '8月', current: 48.0, lastMonth: 48.2, lastYear: 47.5, target: 55.0 },
  { month: '9月', current: 48.2, lastMonth: 48.0, lastYear: 47.8, target: 55.0 },
  { month: '10月', current: 49.1, lastMonth: 48.2, lastYear: 48.0, target: 55.0 },
  { month: '11月', current: 50.0, lastMonth: 49.1, lastYear: 48.5, target: 55.0 },
  { month: '12月', current: 50.5, lastMonth: 50.0, lastYear: 49.0, target: 55.0 },
];
  ...
  return (
    <div className="mb-4">
      ...
      <div className="flex items-center gap-2 text-xs font-medium text-gray-500 relative group cursor-help w-max">
        <span
          className={`px-1.5 py-0.5 rounded ${isUp1 ? 'text-emerald-400 bg-emerald-50' : 'text-rose-600 bg-rose-50'}`}
        >
          {timeCtx.label1} {value1}
        </span>
        <span className="text-gray-300">/</span>
        <span
          className={`px-1.5 py-0.5 rounded ${isUp2 ? 'text-emerald-400 bg-emerald-50' : 'text-rose-600 bg-rose-50'}`}
        >
        ...
        <div className="absolute top-full left-0 mt-2 hidden group-hover:block w-72 bg-gray-900 text-white text-[10px] p-3.5 rounded-xl shadow-xl z-50 normal-case tracking-normal text-left border border-gray-800">
          <div className="flex flex-col gap-2">
            <div className="flex justify-between">
              <span className="text-gray-400 min-w-[80px]">当前期间:</span>
              <span className="font-medium text-white">{timeCtx.currStr}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-400 min-w-[80px]">上一等宽周期:</span>
              <span className="font-medium text-indigo-300">{timeCtx.prevStr}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-400 min-w-[80px]">去年同一期间:</span>
              <span className="font-medium text-indigo-300">{timeCtx.yoyStr}</span>
            </div>
          </div>
...
const NetDepositChart = ({ scale, timeCtx }: { scale: number; timeCtx: any }) => {
  ...
  const maxVal =
    Math.max(...monthDataWithLabels.map((d) => Math.max(d.deposit, d.withdrawal))) * 1.1;
    ...
    >
      <svg viewBox={`0 -25 ${width} ${height + 25}`} className="w-full h-full overflow-visible">
        ...
        <text
          ...
          y={-15}
          textAnchor="end"
          className="fill-gray-400 text-[10px] font-bold tracking-wider"
        >
          WITHDRAWAL (出金)
        </text>
        <text
      ...
      {activeIndex !== null && (
        ...
        >
          <div className="text-[10px] font-black text-gray-400 mb-2 border-b border-gray-800 pb-1.5">
            {monthDataWithLabels[activeIndex].fullRange || monthDataWithLabels[activeIndex].label}
          </div>
          <div className="space-y-1.5 min-w-[120px]">
            <div className="flex justify-between items-center text-xs">
              <span className="text-gray-300">入金:</span>
              <span className="font-bold text-emerald-400">
                +${Math.floor(monthDataWithLabels[activeIndex].deposit).toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between items-center text-xs">
              <span className="text-gray-300">出金:</span>
              <span className="font-bold text-rose-400">
                -${Math.floor(monthDataWithLabels[activeIndex].withdrawal).toLocaleString()}
              </span>
            </div>
            <div className="pt-1.5 border-t border-gray-700 flex justify-between items-center text-xs">
              ...
              <span className="font-bold">
                $
                {Math.floor(
                  monthDataWithLabels[activeIndex].deposit -
                    monthDataWithLabels[activeIndex].withdrawal,
                ).toLocaleString()}
              </span>
            </div>
          </div>
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <div className="flex items-center gap-2 text-xs font-medium text-gray-500 mb-3">
              ...
              <span className="text-gray-300">/</span>
              <span className="px-1.5 py-0.5 rounded text-emerald-400 bg-emerald-50">
                {timeCtx.label2} {trendConv1.value2}
              </span>
            </div>
        ...
        <div className="flex-1 w-full min-h-[140px]">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip
                content={<GenericChartTooltip valueSuffix="%" />}
                cursor={{ stroke: '#e2e8f0', strokeWidth: 1, strokeDasharray: '4 4' }}
              />
              ...
              <Line
                ...
                strokeWidth={1.5}
                strokeDasharray="3 3"
                dot={{ r: 1.5, fill: '#94a3b8', stroke: 'none' }}
                activeDot={{ r: 4 }}
              />
              <Line
                type="monotone"
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <div className="flex items-center gap-2 text-xs font-medium text-gray-500 mb-2">
              ...
              <span className="text-gray-300">/</span>
              <span className="px-1.5 py-0.5 rounded text-emerald-400 bg-emerald-50">
                {timeCtx.label2} {trendConv2.value2}
              </span>
            </div>
            <div className="flex justify-between items-center px-1">
              <span className="text-[10px] text-gray-400 font-medium tracking-tight">
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <div className="flex items-center gap-2 text-xs font-medium text-gray-500 mb-2">
              ...
              <span className="text-gray-300">/</span>
              <span className="px-1.5 py-0.5 rounded text-emerald-400 bg-emerald-50">
                {timeCtx.label2} {trendRet.value2}
              </span>
            </div>
            <div className="flex justify-between items-center px-1">
              <span className="text-[10px] text-gray-400 font-medium tracking-tight">
