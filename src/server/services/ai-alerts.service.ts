...
const ALERTS_BASE: Omit<AIAlert, 'timestamp'>[] = [
  ...
  },
  {
    ...
    region: 'GLOBAL',
    description:
      '全球平均出金时间较上周增长 3.2 倍，用户投诉率上升 45%',
  ...
  },
  {
    ...
    region: 'EU_UK',
    description:
      '英国 Apple Search Ads CPA 升至 $28.5，超出目标值 24%',
  ...
  },
  {
    ...
    region: 'MENA_AE',
    description:
      '阿联酋 App Store 评分从 4.5 降至 4.2，差评主要集中在闪退问题',
  ...
  },
  {
    ...
    region: 'GS_AU',
    description:
      '澳洲市场 D30 留存率下降 5.2%，新手引导完成率偏低',
    action: '优化新手引导流程并增加 Day 3/7 触发推送',
  },
];

export function getAIAlertsData(
  timeRange: string,
  region: string,
): { alerts: AIAlert[] } {
