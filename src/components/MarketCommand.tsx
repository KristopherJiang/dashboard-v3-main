    ...
    () => [
      {
        ...
        tier: 1,
        aso: { val: Math.round(2800 * m), delta: Math.round(85 * m), growth: 3.1 },
        geo: { val: 92, delta: 2, growth: 2.2 },
        seo: { val: Math.round(3200 * m), delta: Math.round(120 * m), growth: 3.8 },
        comps: ['Exness', 'Capital.com'],
      },
      {
        id: 'IN',
        name: '印度',
        coords: { top: '48%', left: '71%' },
        tier: 1,
        aso: { val: Math.round(2450 * m), delta: Math.round(320 * m), growth: 15.0 },
        geo: { val: 72, delta: 14, growth: 24.1 },
        seo: { val: Math.round(1850 * m), delta: Math.round(280 * m), growth: 17.8 },
        comps: ['PU Prime', 'Exness'],
      },
      {
        id: 'VN',
        name: '越南',
        coords: { top: '52%', left: '79%' },
        tier: 2,
        aso: { val: Math.round(1850 * m), delta: Math.round(350 * m), growth: 23.3 },
        geo: { val: 75, delta: 18, growth: 31.6 },
        seo: { val: Math.round(920 * m), delta: Math.round(145 * m), growth: 18.7 },
        comps: ['PU Prime', 'Exness'],
      },
      {
        id: 'AE',
        name: '阿联酋',
        coords: { top: '47%', left: '63%' },
        tier: 2,
        aso: { val: Math.round(1550 * m), delta: Math.round(245 * m), growth: 18.8 },
        geo: { val: 94, delta: 4, growth: 4.4 },
        seo: { val: Math.round(1250 * m), delta: Math.round(180 * m), growth: 16.8 },
        comps: ['Exness', 'CFI'],
      },
      {
        id: 'AU',
        name: '澳大利亚',
        coords: { top: '75%', left: '88%' },
        tier: 2,
        aso: { val: Math.round(820 * m), delta: Math.round(8 * m), growth: 0.9 },
        geo: { val: 88, delta: 0, growth: 0.0 },
        seo: { val: Math.round(950 * m), delta: Math.round(35 * m), growth: 3.8 },
        comps: ['Plus500', 'Capital.com'],
      },
      {
        id: 'GB',
        name: '英国',
        coords: { top: '28%', left: '48.5%' },
        tier: 1,
        aso: { val: Math.round(1100 * m), delta: Math.round(15 * m), growth: 1.4 },
        geo: { val: 89, delta: 1, growth: 1.1 },
        seo: { val: Math.round(1350 * m), delta: Math.round(45 * m), growth: 3.4 },
        comps: ['Capital.com', 'Plus500'],
      },
      {
        id: 'JP',
        name: '日本',
        coords: { top: '37%', left: '86%' },
        tier: 1,
        aso: { val: Math.round(1950 * m), delta: Math.round(-85 * m), growth: -4.2 },
        geo: { val: 78, delta: -5, growth: -6.0 },
        seo: { val: Math.round(1210 * m), delta: Math.round(-35 * m), growth: -2.8 },
        comps: ['Exness', 'CFI'],
      },
      {
        id: 'TH',
        name: '泰国',
        coords: { top: '55%', left: '77%' },
        tier: 2,
        aso: { val: Math.round(1450 * m), delta: Math.round(180 * m), growth: 14.2 },
        geo: { val: 71, delta: 6, growth: 9.2 },
        seo: { val: Math.round(1100 * m), delta: Math.round(95 * m), growth: 9.4 },
        comps: ['Exness', 'XM'],
      },
      {
        id: 'MY',
        name: '马来西亚',
        coords: { top: '60%', left: '77.5%' },
        tier: 2,
        aso: { val: Math.round(1280 * m), delta: Math.round(90 * m), growth: 7.5 },
        geo: { val: 68, delta: 4, growth: 6.2 },
        seo: { val: Math.round(1150 * m), delta: Math.round(120 * m), growth: 11.6 },
        comps: ['Exness', 'FXTM'],
      },
      {
        id: 'RU',
        ...
        tier: 1,
        aso: { val: Math.round(1650 * m), delta: Math.round(-180 * m), growth: -9.8 },
        geo: { val: 58, delta: -12, growth: -17.2 },
        seo: { val: Math.round(1900 * m), delta: Math.round(-50 * m), growth: -2.6 },
        comps: ['Exness', 'CFI'],
      },
      {
        id: 'PK',
        ...
        tier: 2,
        aso: { val: Math.round(980 * m), delta: Math.round(140 * m), growth: 16.7 },
        geo: { val: 45, delta: 3, growth: 7.1 },
        seo: { val: Math.round(620 * m), delta: Math.round(45 * m), growth: 7.8 },
        comps: ['Exness', 'XM'],
      },
      {
        id: 'ID',
        name: '印尼',
        coords: { top: '62%', left: '81%' },
        tier: 2,
        aso: { val: Math.round(1600 * m), delta: Math.round(120 * m), growth: 8.1 },
        geo: { val: 68, delta: 5, growth: 7.9 },
        seo: { val: Math.round(840 * m), delta: Math.round(60 * m), growth: 7.7 },
        comps: ['Exness', 'CFI'],
      },
      {
        id: 'PH',
        name: '菲律宾',
        coords: { top: '50%', left: '83%' },
        tier: 2,
        aso: { val: Math.round(1200 * m), delta: Math.round(110 * m), growth: 10.1 },
        geo: { val: 62, delta: 4, growth: 6.9 },
        seo: { val: Math.round(750 * m), delta: Math.round(55 * m), growth: 7.9 },
        comps: ['Exness', 'XM'],
      },
      {
        id: 'CO',
        name: '哥伦比亚',
        coords: { top: '52%', left: '28%' },
        tier: 2,
        aso: { val: Math.round(560 * m), delta: Math.round(45 * m), growth: 8.7 },
        geo: { val: 41, delta: 2, growth: 5.1 },
        seo: { val: Math.round(380 * m), delta: Math.round(20 * m), growth: 5.6 },
        comps: ['Exness', 'XM'],
      },
      {
        id: 'SA',
        name: '沙特',
        coords: { top: '46%', left: '60%' },
        tier: 2,
        aso: { val: Math.round(1200 * m), delta: Math.round(100 * m), growth: 9.1 },
        geo: { val: 82, delta: 6, growth: 7.9 },
        seo: { val: Math.round(950 * m), delta: Math.round(85 * m), growth: 9.8 },
        comps: ['CFI', 'Exness'],
      },
    ],
    [m],
        ...
        {hoveredCountry && (
          <div className="absolute right-6 bottom-6 w-[220px] bg-gradient-to-br from-[#111827] to-[#030712] rounded-2xl p-4 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.6)] border border-slate-800/80 z-50 animate-in fade-in zoom-in-95 duration-200">
            <div className="flex justify-between items-start mb-3">
              <div>
                <h3 className="text-base font-black tracking-tight text-white leading-tight mb-0.5">
                  {hoveredCountry.name}
                </h3>
                <p className="text-[8px] text-slate-400 font-bold uppercase tracking-widest">
                  {activeConfig.metricName}
                </p>
              </div>
              ...
              <div className="flex justify-between items-center">
                <div className="space-y-0.5">
                  ...
                  <div className="flex items-center gap-0.5">
                    ...
                    <span
                      className={`text-xs font-black ${hoveredCountry[activeTab.toLowerCase()].delta >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}
                    >
                      {hoveredCountry[activeTab.toLowerCase()].delta >= 0 ? '+' : '-'}
                      {Math.abs(hoveredCountry[activeTab.toLowerCase()].delta)}
                      {activeConfig.unit}
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-0.5 text-right">
                  ...
                  <p className="text-xs font-bold text-slate-300">
                    {hoveredCountry[activeTab.toLowerCase()].val}
                    {activeConfig.unit}
                  </p>
                </div>
              </div>
            ...
            <div className="pt-2.5 border-t border-slate-800">
              ...
              <div className="flex gap-1.5">
                {hoveredCountry.comps.slice(0, 2).map((comp: string, idx: number) => (
                  <div
                    key={idx}
                    className="flex-1 bg-slate-800/30 border border-slate-700/50 px-1.5 py-1 rounded-md flex items-center justify-center gap-1"
                  >
        ...
        <div className="flex flex-wrap items-center gap-6 xl:gap-12">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="h-2 w-32 xl:w-48 rounded-full bg-slate-200 overflow-hidden">
                <div
                  className={`h-full transition-all duration-700 ${mode === 'Absolute' ? 'bg-emerald-400' : 'bg-gradient-to-r from-rose-500 via-slate-300 to-emerald-400'}`}
                  style={{ width: '100%' }}
                ></div>
              </div>
          ...
          <div className="flex items-center gap-4 xl:border-l xl:border-slate-200 xl:pl-6">
            ...
            <div>
              ...
              <p className="text-[12px] font-bold text-slate-700 italic">
                在 {activeTab} 模块下，{mode === 'Absolute' ? '核心' : '新兴'}
                市场展现出明显的梯队分布。
              </p>
            </div>
          </div>
